...
<div class="pt-24 bg-slate-100 min-h-screen">
    ...
    <section class="bg-slate-100 border-t border-b border-slate-200 py-24 px-6 md:px-12 relative">
            ...
            <div class="grid md:grid-cols-2 gap-12">
                ...
                <a href="{{ route('destinasi.pantai-karang-jahe') }}" class="group relative bg-white rounded-none shadow hover:shadow-md transition-all duration-500 overflow-hidden flex flex-col justify-between h-full border border-gray-200">
                    <div class="overflow-hidden aspect-[16/10] relative">
                        ...
                        <!-- Floating Tag -->
                        <span class="absolute top-4 left-4 bg-white/90 px-4 py-1.5 rounded-none text-slate-800 text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 border border-slate-200/50 shadow-sm">
                    ...
                    <div class="p-8 space-y-4 flex-grow flex flex-col justify-between">
                        <div>
                            <h3 class="text-2xl font-bold text-gray-900 font-sans group-hover:text-sky-600 transition duration-300 flex items-center justify-between">
                                Pantai Karang Jahe
                            ...
                            <p class="text-gray-600 font-sans text-sm md:text-base leading-relaxed text-justify mt-3">
