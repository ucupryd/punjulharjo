...
<div x-data="{ activeTab: 'ebook' }" class="pt-24 bg-slate-100 min-h-screen font-sans">
    ...
    <!-- Navigation Tabs -->
    <div class="max-w-6xl mx-auto px-6 mt-12 flex justify-center">
        <div class="inline-flex p-1.5 bg-white shadow-sm border border-slate-200 gap-1.5 rounded-none">
            <button @click="activeTab = 'ebook'" 
                    ...
                    class="px-6 py-2.5 text-sm font-semibold transition flex items-center gap-2">
