...
<div class="py-10 bg-slate-50 min-h-[85vh]">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="flex justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
            <div>
                <span class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Perbarui Kategori</span>
                <h1 class="text-2xl font-bold text-slate-800 font-title mt-0.5">Edit: {{ $category->name }}</h1>
            </div>
