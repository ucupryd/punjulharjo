...
@section('content')
    ...
    <section class="py-20 bg-white px-6">
        <div class="max-w-5xl mx-auto text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-sky-600 mb-8">Lokasi Kami</h2>
            ...
            <div class="rounded-xl overflow-hidden shadow-lg border border-sky-100 max-w-3xl mx-auto">
    ...
    <!-- Kontak -->
    <section class="py-20 bg-sky-50 px-6">
        <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
                <h2 class="text-3xl md:text-4xl font-bold text-sky-600 mb-6">Hubungi Kami</h2>
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                <h3 class="text-2xl font-semibold text-sky-600 mb-4 text-center">Kirim Pesan</h3>
    ...
    <section class="py-20 bg-white px-6">
        <div class="max-w-5xl mx-auto text-center">
            <h2 class="text-3xl md:text-4xl font-bold text-sky-600 mb-8">Akses ke Desa Wisata Punjulharjo</h2>
            ...
            <div class="grid md:grid-cols-3 gap-10 text-left">
                <div class="p-6 bg-sky-50 rounded-xl shadow hover:shadow-lg transition">
                    <h3 class="text-xl font-semibold mb-2 text-sky-600">🚗 Kendaraan Pribadi</h3>
                ...
                <div class="p-6 bg-sky-50 rounded-xl shadow hover:shadow-lg transition">
                    <h3 class="text-xl font-semibold mb-2 text-sky-600">🚌 Transportasi Umum</h3>
                    <p class="text-gray-700 text-sm leading-relaxed">
                ...
                <div class="p-6 bg-sky-50 rounded-xl shadow hover:shadow-lg transition">
                    <h3 class="text-xl font-semibold mb-2 text-sky-600">🚴‍♂️ Wisata Sepeda</h3>
                    <p class="text-gray-700 text-sm leading-relaxed">
